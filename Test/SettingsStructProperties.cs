...
namespace Test.Cave.IO
{
    public struct SettingsStructProperties : IEquatable<SettingsStructProperties>
    {
        ...
        public static bool operator !=(SettingsStructProperties left, SettingsStructProperties right) => !(left == right);

        public static bool operator ==(SettingsStructProperties left, SettingsStructProperties right) => left.Equals(right);

        public static SettingsStructProperties RandomStruct(CultureInfo culture = null)
        {
        ...
        public bool Equals(SettingsStructProperties other) => Equals(other.SampleString, SampleString) &&
        ...
        public override bool Equals(object obj) => obj is SettingsStructProperties properties && Equals(properties);
