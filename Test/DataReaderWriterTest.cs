...
public class DataReaderWriterTest
{
    ...
    public void Iso2022Test()
    {
        ...
        Assert.Ignore("ISO 2022 is not supported with netcore!");
#else
    ...
    public void TestPrimitives()
    {
        ...
        writer.Write(TimeSpan.MinValue);
        writer.Write(TimeSpan.MaxValue);
        writer.Write(Guid.Empty);
        var guid = Guid.NewGuid(); writer.Write(guid);
        writer.WriteZeroTerminated(string.Empty);
        writer.WriteZeroTerminated(AceOfSpades);
        writer.Flush();
        ...
        Assert.AreEqual(DateTime.MinValue, reader.ReadDateTime());
        Assert.AreEqual(DateTime.MaxValue, reader.ReadDateTime());
        Assert.AreEqual(TimeSpan.MinValue, reader.ReadTimeSpan());
        Assert.AreEqual(TimeSpan.MaxValue, reader.ReadTimeSpan());
        Assert.AreEqual(Guid.Empty, reader.ReadGuid());
        Assert.AreEqual(guid, reader.ReadGuid());
        Assert.AreEqual(string.Empty, reader.ReadZeroTerminatedString(100));
        Assert.AreEqual(AceOfSpades, reader.ReadZeroTerminatedString(100));
        reader.Flush();
    ...
    public void TestPrimitivesNullable()
    {
        ...
        writer.WritePrefixed((decimal?)0);
        writer.WritePrefixed(DateTime.MinValue);
        writer.WritePrefixed(DateTime.MaxValue);
        writer.WritePrefixed((DateTime?)null);
        writer.WritePrefixed((DateTime?)new DateTime(0));
        writer.WritePrefixed(TimeSpan.MinValue);
        writer.WritePrefixed(TimeSpan.MaxValue);
        writer.WritePrefixed((TimeSpan?)null);
        writer.WritePrefixed((TimeSpan?)new TimeSpan(0));
        writer.WritePrefixed(Guid.Empty);
        var guid = Guid.NewGuid(); writer.WritePrefixed(guid);
        writer.WritePrefixed((Guid?)null);
        writer.WritePrefixed((string)null);
        ...
        Assert.AreEqual(null, reader.ReadPrefixedInt8());
        ...
        Assert.AreEqual(null, reader.ReadPrefixedUInt16());
        ...
        Assert.AreEqual(null, reader.ReadPrefixedInt32());
        ...
        Assert.AreEqual(null, reader.ReadPrefixedInt64());
        ...
        Assert.AreEqual((decimal?)0, reader.ReadPrefixedDecimal());
        Assert.AreEqual(DateTime.MinValue, reader.ReadPrefixedDateTime());
        Assert.AreEqual(DateTime.MaxValue, reader.ReadPrefixedDateTime());
        Assert.AreEqual(null, reader.ReadPrefixedDateTime());
        Assert.AreEqual((DateTime?)new DateTime(0), reader.ReadPrefixedDateTime());
        Assert.AreEqual(TimeSpan.MinValue, reader.ReadPrefixedTimeSpan());
        Assert.AreEqual(TimeSpan.MaxValue, reader.ReadPrefixedTimeSpan());
        Assert.AreEqual(null, reader.ReadPrefixedTimeSpan());
        Assert.AreEqual((TimeSpan?)new TimeSpan(0), reader.ReadPrefixedTimeSpan());
        Assert.AreEqual(Guid.Empty, reader.ReadPrefixedGuid());
        Assert.AreEqual(guid, reader.ReadPrefixedGuid());
        Assert.AreEqual(null, reader.ReadPrefixedGuid());
