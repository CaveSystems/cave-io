...
{
    /// <summary>
    /// Provides a id in binary form. This is much more memory efficient if storing a large amount of guids.
    /// </summary>
    public sealed class BinaryGuid : IComparable<BinaryGuid>, IComparable
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Guid"/> to <see cref="BinaryGuid"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="BinaryGuid"/> to <see cref="Guid"/>.
        /// </summary>
        /// <param name="id">The unique identifier.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Tries to parse the specified id.
        /// </summary>
        /// <param name="text">The text.</param>
        /// <param name="id">The unique identifier.</param>
