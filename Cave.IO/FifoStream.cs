...
{
    /// <summary>
    /// Provides a fifo buffer for byte[] blocks readable as stream. New buffers can be appended to the end of the stream and read like a stream. The
    /// performance of this class is best with medium sized buffers (1kiB - 64kiB).
    /// </summary>
