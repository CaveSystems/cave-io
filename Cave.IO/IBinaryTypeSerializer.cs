...
/// <summary>Provides an interface for binary serialization.</summary>
public interface IBinaryTypeSerializer
{
    #region Public Methods

    /// <summary>Checks whether a type can be serialized using this serializer or not.</summary>
    /// <param name="type"></param>
    /// <returns>Returns true if deserialization is available, false otherwise.</returns>
    public bool CanDeserialize(Type type);

    /// <summary>Checks whether an item can be serialized using this deserializer or not.</summary>
    ...
    /// <summary>Deserializes the specified <paramref name="type"/>.</summary>
    ...
    /// <summary>Serializes the specified <paramref name="item"/>.</summary>
