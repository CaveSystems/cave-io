...
/// <summary>
/// Metadata for a serializable member (field or property).
/// </summary>
internal sealed class BlobReflectionConverterMember
{
    ...
    /// <summary>
    /// Converter bundle for (de)serializing the member value.
    /// </summary>
    internal readonly BlobConverterBundle Bundle;

    /// <summary>
    /// Reflection info for the member (<see cref="FieldInfo"/> or <see cref="PropertyInfo"/>).
    /// </summary>
    internal readonly MemberInfo Member;

    /// <summary>
    /// Setter delegate for assigning deserialized values.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new <see cref="BlobReflectionConverterMember"/>.
    /// </summary>
