...
public class BlobBinaryConstructorConverter : BlobConverterBase
{
    /// <inheritdoc/>
    protected override object? GetCanHandleCache(Type type)
    {
        ...
        return canHandle ? new BlobBinaryConstructorConverterState(type) : null;
    }
    ...
    /// <inheritdoc/>
    public override void ReadInitialization(IBlobReaderState state, BlobConverterBundle bundle) => bundle.State = new BlobBinaryConstructorConverterState(bundle.Type);
    ...
    public override void WriteInitialization(IBlobWriterState state, BlobConverterBundle bundle)
    {
        ...
        bundle.State = new BlobBinaryConstructorConverterState(bundle.Type);
    }
